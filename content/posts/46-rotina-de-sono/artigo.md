...
keywords:
  ...
  secundarias:
    ...
    - rotina noturna bebê
    - criar hábito de sono
    - higiene do sono bebê
  long_tails:
    - como estabelecer rotina de sono para bebê de 3 meses
    - rotina de sono funciona a partir de quando
category: sono
phase: 3-6m
tone: misto
format: guia
...
- [Por que rotinas funcionam?](#por-que-rotinas-funcionam)
- [Quando começar?](#quando-começar)
- [Os blocos de uma boa rotina de sono](#os-blocos-de-uma-boa-rotina-de-sono)
- [Quanto tempo deve durar a rotina?](#quanto-tempo-deve-durar-a-rotina)
- [O conceito de "sonolento mas acordado"](#o-conceito-de-sonolento-mas-acordado)
- [O ambiente ideal para dormir](#o-ambiente-ideal-para-dormir)
