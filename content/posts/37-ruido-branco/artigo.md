...
keywords:
  ...
  secundarias:
    - ruído branco recém-nascido
    - som para bebê dormir
    - máquina de ruído branco
    - ruído branco faz mal
    - como usar ruído branco bebê
  long_tails:
    - ruído branco pode prejudicar audição do bebê
...
- [O que é ruído branco?](#o-que-é-ruído-branco)
...
2. [SBP. Higiene do Sono. Documento Científico — Departamento de Medicina do Sono.](https://www.sbp.com.br/fileadmin/user_upload/19807c-DocCient_-_Higiene_do_Sono.pdf)
...
*O Yaya acompanha o sono do bebê — registre se o ruído branco está fazendo diferença nas sonecas e noites.*
