...
keywords:
  ...
  secundarias:
    ...
    - rede de apoio puerpério
    - ajuda no pós-parto
    - pai no pós-parto
    - divisão de tarefas com bebê
  long_tails:
    - como aceitar ajuda no puerpério
    - como pedir ajuda sem culpa maternidade
category: saude
phase: gestante
tone: amigo
format: guia prático
target_week_start: 30
target_week_end: 12
...
**Fontes:**
- OMS — Recommendations on Maternal and Newborn Care for a Positive Postnatal Experience
- SBP — A importância do vínculo e do apoio familiar no puerpério
- AAP — The Importance of Social Support for New Parents
