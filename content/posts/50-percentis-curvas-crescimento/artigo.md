...
keywords:
  ...
  secundarias:
    ...
    - percentil peso bebê
    - percentil altura bebê
    - caderneta da criança curvas
    - como ler gráfico de crescimento
  long_tails:
    - meu bebê está no percentil 10 é normal
    - diferença entre curva OMS e CDC
category: saude
phase: 3-6m
tone: especialista
format: guia + tabela
...
- [O que são percentis?](#o-que-são-percentis)
- [Percentil é nota?](#percentil-é-nota)
- [Curvas OMS vs. CDC: qual o Brasil usa?](#curvas-oms-vs-cdc-qual-o-brasil-usa)
...
- [Quando o pediatra se preocupa?](#quando-o-pediatra-se-preocupa)
- [Resumindo](#resumindo)
