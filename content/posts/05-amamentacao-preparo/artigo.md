...
description: >-
  ...
  se prepara e o que realmente ajuda nos primeiros dias.
keywords:
  primaria: como se preparar para amamentar
  secundarias:
    - amamentação na gestação
    - preparar mama para amamentar
    - colostro o que é
    - amamentação primeiros dias
    - curso de amamentação
    - dificuldades amamentação início
  long_tails:
    - como preparar o seio para amamentação
    - o que saber sobre amamentação antes do parto
    - amamentação dói no começo
...
schema: Article
meta_description: >-
  Como se preparar para a amamentação durante a gestação: o que o corpo faz,
  mitos, pega correta e o que esperar nos primeiros dias.
audience: gestante
affiliate_products:
  - tipo: transporte
...
lead_magnet: false
image_url: >-
  https://blog.yayababy.app/posts/amamentacao-o-que-saber-antes-do-bebe-nascer/hero.webp
mid_image_url: >-
  https://blog.yayababy.app/posts/amamentacao-o-que-saber-antes-do-bebe-nascer/mid.webp
---
...
**Primeira semana:** a pega pode doer nos primeiros segundos de cada sessão. Se a dor persiste durante toda a amamentação ou se há fissuras, busque ajuda. Dor contínua não é normal e tem solução.

## Amamentação e rede de apoio

O parceiro, a família e quem estiver por perto precisam entender que nos primeiros dias a prioridade é amamentar e descansar. Ajuda prática significa: trazer água, preparar comida, cuidar da casa, segurar o bebê entre as amamentações. Não significa dar palpite sobre "pouco leite" ou "bebê que chora porque tem fome".
