...
keywords:
  ...
  secundarias:
    - sinais de alerta recém-nascido
    - febre recém-nascido pronto-socorro
    - bebê com dificuldade para respirar
    - quando ir ao PS com bebê
  long_tails:
    - febre de quanto graus é perigoso para recém-nascido
    - quando a golfada do bebê é preocupante
category: saude
phase: 0-3m
tone: especialista
format: checklist
...
![Mãe preocupada medindo a temperatura de um bebê recém-nascido com termômetro digital na axila](img39-1.png)
...
- [O que NÃO é emergência](#o-que-não-é-emergência)
- [Quando ligar pro pediatra antes de ir ao PS](#quando-ligar-pro-pediatra-antes-de-ir-ao-ps)
- [UPA, hospital ou PS: qual escolher](#upa-hospital-ou-ps-qual-escolher)
- [O que levar ao pronto-socorro](#o-que-levar-ao-pronto-socorro)
- [Resumindo](#resumindo)
...
![Pai organizando bolsa com documentos do bebê para levar ao pronto-socorro](img39-2.png)
