...
description: >-
  ...
  instalação ISOFIX, legislação brasileira, erros comuns e como garantir a
  segurança do seu filho.
meta_description: >-
  Cadeirinha de bebê: como escolher por grupo, instalar corretamente, lei
  brasileira 2026 e erros comuns. Guia completo de segurança.
keywords:
  primaria: cadeirinha bebê como escolher
  secundarias:
    - cadeirinha bebê recém-nascido
    - bebê conforto carro
    - cadeirinha INMETRO
    - lei cadeirinha 2026
    - como instalar cadeirinha bebê
    - cadeirinha grupo 0
  long_tails:
    - qual cadeirinha para recém-nascido
    - cadeirinha virada para trás até quando
    - cadeirinha carro é obrigatória
category: seguranca
phase: gestante
tone: amigo
...
seo:
  ...
  schema: Article
  snippet_type: tabela
  snippet_section: Grupos de cadeirinha por peso e idade
sources:
  ...
  - name: CONTRAN — Resolução 277/2008 (Dispositivos de Retenção para Crianças)
    url: >-
      https://www.gov.br/transportes/pt-br/assuntos/transito/conteudo-contran/resolucoes/resolucao_contran_277.pdf
...
image_url: 'https://blog.yayababy.app/posts/cadeirinha-bebe-carro/hero.webp'
image_alt: 'Cadeirinha do Carro: Como Escolher e Instalar'
mid_image_url: 'https://blog.yayababy.app/posts/cadeirinha-bebe-carro/mid.webp'
---
...
- [A lei brasileira: o que diz](#a-lei-brasileira-o-que-diz)
- [Grupos de cadeirinha por peso e idade](#grupos-de-cadeirinha-por-peso-e-idade)
- [Por que virada para trás é mais seguro](#por-que-virada-para-trás-é-mais-seguro)
- [ISOFIX ou cinto de segurança](#isofix-ou-cinto-de-segurança)
- [Como saber se a cadeirinha tem certificação](#como-saber-se-a-cadeirinha-tem-certificação)
- [Erros comuns na instalação](#erros-comuns-na-instalação)
- [Cadeirinha usada: é seguro?](#cadeirinha-usada-é-seguro)
- [Quando trocar de grupo](#quando-trocar-de-grupo)
...
**Fontes:**
- Código de Trânsito Brasileiro (CTB), Art. 64
- CONTRAN — Resolução 277/2008
