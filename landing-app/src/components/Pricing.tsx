  ...
  async function handleCheckout(planId: string) {
    ...
    try {
      ...
      const res = await fetch(
        `${SUPABASE_URL}/functions/v1/stripe-create-subscription-session`,
        {
          method: 'POST',
          headers: {
      ...
      if (!data?.url) throw new Error(data?.error || 'Não foi possível iniciar o pagamento.')
    ...
    <section ref={ref} className="reveal py-20 px-5" id="planos">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-14">
          <p className="font-headline text-xs font-bold uppercase tracking-[0.18em] text-purple/70 mb-3">
            Planos Yaya+
          </p>
          <h2 className="font-headline text-3xl md:text-4xl font-extrabold mb-3">
            Comece gratis.{' '}
            <span className="text-purple">Evolua quando quiser.</span>
          </h2>
                ...
                <div
                  style={{
                    ...
                    border: plan.highlight
                      ? 'none'
                      : '1px solid rgba(183,159,255,0.12)',
                    display: 'flex',
                ...
                >
                  ...
                  <p
                    style={{
                      fontSize: 12,
                      fontFamily: 'Plus Jakarta Sans, system-ui, sans-serif',
                      color: plan.highlight ? '#b79fff' : 'rgba(231,226,255,0.4)',
                      marginBottom: plan.includesLibrary ? 12 : 20,
                    }}
                  >
                    {plan.note}
                  </p>
        ...
        <div className="flex items-center gap-4 my-10">
          ...
          <span className="font-body text-xs text-muted/40">ou comece pelo app</span>
          <div className="flex-1 h-px bg-purple/10" />
        </div>

        {/* Free tier note */}
        <div className="glass rounded-2xl p-6 text-center max-w-md mx-auto">
          <h3 className="font-headline font-bold text-cloud mb-2">Yaya Free</h3>
          ...
          <div className="flex gap-3 justify-center">
            <a
              ...
              className="px-5 py-2.5 rounded-xl border border-purple/25 text-purple font-headline font-bold text-sm hover:bg-purple/10 transition-colors"
            >
              App Store
            </a>
            <a
