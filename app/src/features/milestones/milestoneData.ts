...
export const MILESTONES: Milestone[] = [
  ...
  { code: 'responds_to_name_command', name: 'Entende comandos simples',    description: 'Responde a "não", "vem cá", "dá" — compreende sem precisar ver gestos.', emoji: '👂', category: 'linguagem', typicalAgeDaysMin: 240, typicalAgeDaysMax: 300, ageBand: 'active', sortOrder: 20 },
  ...
  { code: 'vocab_20_words',  name: 'Vocabulário de 20+ palavras',         description: 'Usa pelo menos 20 palavras com intenção — fase de explosão de vocabulário.', emoji: '🗣️', category: 'linguagem', typicalAgeDaysMin: 455, typicalAgeDaysMax: 545, ageBand: 'toddler_early', sortOrder: 27 },
  ...
  { code: 'uses_pronouns',   name: 'Usa "eu" ou "meu"',                   description: 'Começa a usar pronomes pessoais, demonstrando senso de identidade.', emoji: '🙋', category: 'linguagem', typicalAgeDaysMin: 630, typicalAgeDaysMax: 730, ageBand: 'toddler', sortOrder: 33 },
