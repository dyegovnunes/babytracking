          ...
          <div className="mb-5 p-3 rounded-md bg-surface-container">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="flex-1 px-3 py-3 rounded-md bg-surface-container-highest border border-white/5 text-on-surface font-body text-sm focus:outline-none focus:border-primary/40 min-h-[44px]"
              />
              <button
                type="button"
