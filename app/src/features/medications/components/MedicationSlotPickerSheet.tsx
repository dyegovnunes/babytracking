...
export default function MedicationSlotPickerSheet({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-md rounded-t-md bg-surface-container-highest p-6 pb-[calc(1.5rem+env(safe-area-inset-bottom))] max-h-[70vh] overflow-y-auto animate-slide-up"
